...
describe('TransactionApi', () => {
  ...
  it('should create a instance of Transaction from createTransaction', () => {
    return api.createTransaction({
      ...
      recipientId: address,
      vendorField: 'Send transaction by mlc-tsc',
    }).forEach((transaction) => {
  ...
  it('should create an instance of transaction with given parameters', () => {
    return api.createTransaction({
      ...
      expect(transaction.vendorField).to.be.eq('Send transaction by mlc-tsc');
  ...
  it('should create a instance of Transaction from createVote', () => {
    ...
    vote.vendorField = 'Send vote transaction by mlc-tsc';
    return api.createVote(vote).forEach((transaction) => {
      ...
      expect(transaction.vendorField).to.be.eq('Send vote transaction by mlc-tsc');
    });
  });
  ...
  it('should create a instance of Transaction from createDelegate', () => {
    ...
    delegate.vendorField = 'Send delegate transaction by mlc-tsc';
    ...
    return api.createDelegate(delegate).forEach((transaction) => {
      ...
      expect(transaction.vendorField).to.be.eq('Send delegate transaction by mlc-tsc');
    });
  });

  it('should create a instance of Transaction from createSignature', () => {
    return api.createSignature('my secret', 'my second secret passphrase', 'Send signature transaction by mlc-tsc').forEach((transaction) => {
      expect(transaction).to.be.instanceOf(Transaction);
      expect(transaction.type).to.be.eq(TransactionType.SecondSignature);
      expect(transaction.vendorField).to.be.eq('Send signature transaction by mlc-tsc');
    });
  });
